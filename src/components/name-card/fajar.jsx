    ...
    <div className="border border-gray-300 p-4 rounded-lg max-w-sm">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2">
          ...
          />
          <div>
            <h1 className="font-bold text-lg">Fajar Setyanusa</h1>
            <h2 className="text-sm">Manajemen Informatika</h2>
          </div>
        </div>
        <p className="text-gray-500">
          "Halo, perkenalkan nama saya Fajar Setyanusa saya adalah salah satu
          Peserta dari SINTAK 2025, Saya Dari kelas 2MIA. Salam kenal
          semuanya..."
        </p>
        <a
