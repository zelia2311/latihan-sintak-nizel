    ...
    <div className="border border-gray-300 p-4 rounded-lg max-w-sm">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2">
          ...
          />
          <div>
            <h1 className="font-bold text-lg">Sri Rahayu Rezeki</h1>
            <h2 className="text-sm">Manajemen Informatika</h2>
          </div>
        </div>
        <p className="text-gray-500">
          "Halo, perkenalkan nama saya Sri Rahayu Rezeki saya adalah salah
          satu peserta pelatihan dari SINTAK 2025. Salam kenal semuanya..."
        </p>
        <a
